	...
	tests := []struct {
	...
	}{
		{
			...
			input: map[string]map[string]string{
				...
				"3": {"API_URL": "https://api-${zeropsSubdomainHost}-3000.prg1.zerops.app"},
				"4": {"API_URL": "https://api-${zeropsSubdomainHost}-3000.prg1.zerops.app"},
				"5": {"API_URL": "https://api-${zeropsSubdomainHost}-3000.prg1.zerops.app"},
			},
			want: map[string]map[string]string{
				"0": {"DEV_API_URL": "https://apidev-${zeropsSubdomainHost}-3000.prg1.zerops.app"},
				"1": {"DEV_API_URL": "https://apidev-${zeropsSubdomainHost}-3000.prg1.zerops.app"},
		...
		},
		{
			...
			initial: map[string]map[string]string{"2": {"API_URL": "https://api.example"}},
			input:   nil,
			want:    map[string]map[string]string{"2": {"API_URL": "https://api.example"}},
		},
		{
			name:    "invalid_env_key_rejected",
			initial: nil,
			input: map[string]map[string]string{
				"6": {"API_URL": "https://api.example"},
			},
			wantErr: true,
		},
		{
